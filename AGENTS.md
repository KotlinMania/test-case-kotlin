...
This file is the quick-reference operating contract for test-case-kotlin. The longer
...
test-case-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`test-case`](https://crates.io/crates/test-case). Upstream Rust is the behavioral oracle while the
