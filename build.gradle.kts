...
kotlin {
    ...
    val xcf = XCFramework("TestCase")

    macosArm64 {
        binaries.framework { baseName = "TestCase"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "TestCase"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "TestCase"
        flattenPackage = "io.github.kotlinmania.testcase"
    }

    android {
        namespace = "io.github.kotlinmania.testcase"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "test-case-kotlin", version.toString())

    pom {
        name.set("test-case-kotlin")
        description.set("Kotlin Multiplatform port of frondeus/test-case - Provides #[test_case(...)] procedural macro attribute for generating parametrized test cases easily")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/test-case-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/test-case-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/test-case-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/test-case-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTestCaseXCFramework",
    "assembleTestCaseDebugXCFramework",
    "assembleTestCaseReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTestCaseXCFramework",
    "assembleReleaseIosFatFrameworkForTestCaseXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTestCaseXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTestCaseXCFramework",
    "assembleDebugMacosFatFrameworkForTestCaseXCFramework",
    "assembleReleaseMacosFatFrameworkForTestCaseXCFramework",
    "assembleDebugTvosFatFrameworkForTestCaseXCFramework",
    "assembleReleaseTvosFatFrameworkForTestCaseXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTestCaseXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTestCaseXCFramework",
    "assembleDebugWatchosFatFrameworkForTestCaseXCFramework",
    "assembleReleaseWatchosFatFrameworkForTestCaseXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTestCaseXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTestCaseXCFramework",
